...
// 47 TokenType,wowwwww, very long. Longest was to implement float in the middle of the way. Crazy long logic. 
    typedef enum {
    ...
    typedef struct {
        ...
        float float_val;      // only valid when type == TOK_INTEGER
        char lexeme[128];
